...
for ix,seg in enumerate(score_segments):
    if ix and ix%200==0: print('match',ix,'/',len(score_segments),'cand',len(candidates),flush=True)
...
# no representative thinning for 2021 anchor; keep adjacent source linelets so boundaries do not break artificially.
